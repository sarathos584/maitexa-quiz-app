        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold text-card-foreground">Edit Question</h1>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update the question details and options</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="isActive">Active (visible in quiz)</Label>
                </div>
